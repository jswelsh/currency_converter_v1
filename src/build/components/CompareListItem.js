...
var gridBuilder = function (props) {
    return React.createElement(Grid, { item: true, xs: 3 }, " ", props, " ");
};
var CompareListItem = function (_a) {
    ...
    return (React.createElement(Card, { className: classes.Card }, React.createElement(ListItem, { button: true, onClick: function () { return currencySelectHandler(currency); }, className: clsx(classes.ListItem, (_b = {},
            _b[classes.selected] = (fromCurrency === currency),
            _b)) }, React.createElement(Grid, { container: true, spacing: 1, direction: "row", justify: "space-around" }, gridBuilder(iconHandler('compare', currency)), gridBuilder(React.createElement(ListItemText, null, React.createElement(Typography, { variant: 'h5' }, currency), React.createElement(Typography, null, data[currency]['name']))), gridBuilder(React.createElement("div", null, CurrencySymbol(currency), React.createElement(ListItemText, { primary: primary })))))));
};
