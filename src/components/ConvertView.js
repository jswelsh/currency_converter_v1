...
const ConvertView = ({ recentRateHistory, fromCurrency, toCurrency, opendrawer, fromIntro, converted, toStart, toIntro, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Grid, { container: true, justify: 'center', className: clsx({
            ...
            React.createElement(FrontSide, null,
                React.createElement(ConvertViewFrontsideCard, { currency: currency, symbol: data[currency]['symbol_native'], amount: amount, avatar: iconHandler('converter', currency) }),
                "title=",
                data[currency]['name']),
            React.createElement(BackSide, null,
                React.createElement(ConvertViewBacksideCard, { currency: currency, name: data[currency]['name'], recentRateHistory: recentRateHistory, converted: converted, avatar: iconHandler('converter', currency) })))))),
        React.createElement(Grid, { container: true, justify: 'center', className: clsx({
                [classes.drawerOpen]: opendrawer,
                [classes.drawerClose]: !opendrawer
            }) },
