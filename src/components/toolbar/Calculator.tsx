  ...
  return (
    <Card className={classes.Card}>
      ...
      <Grid container
        ...
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '8'})}>8</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '9'})}>9</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_OPERAND', payload: '*'})}>x</ListItem></Grid>
        {/* row */}
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '4'})}>4</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '5'})}>5</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '6'})}>6</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_OPERAND', payload: '+'})}>+</ListItem></Grid>
        {/* row */}
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '1'})}>1</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '2'})}>2</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_NUMBER', payload: '3'})}>3</ListItem></Grid>
        <Grid item xs={3}> <ListItem className={classes.Button} button divider color='primary' onClick={() => dispatch({ type: 'SET_OPERAND', payload: '-'})}>-</ListItem></Grid>
        {/* row */}
