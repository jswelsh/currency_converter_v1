...
const CompareListItem = ({ currencySelectHandler, fromCurrency, currency, primary, }) => {
    ...
    return (React.createElement(Card, { className: classes.Card },
        React.createElement(ListItem, { button: true, onClick: () => currencySelectHandler(currency), className: clsx(classes.ListItem, {
